...
- 五行讲完后，再用 1 句总结此人最强的 1-2 种能量和最需要补足/疏通的 1 种能量。
...
- 2026 至少写：事业机会、财富风险、一个需要避开的行为。
- 2027 至少写：事业延续/转向、收入结构变化、一个适合提前布局的方向。
...
"""
                ...
                live_constraint = "\n\n⚠️【重要提醒：直播快速简评模式】：当前由直播快速引擎驱动，你【只需输出】【### 📜 PARTE 0: 直播总体简单评价】这一个模块，严禁输出 PARTE I/II/III/IV 等任何后续深度模块。务必满足：纯中文、900-1300字、一句一段、段间空行、直白通俗。必须依据【程序排盘预校验】的日主、年月日柱或四柱、生肖、年柱纳音、五行旺衰和十神主轴来写，但不要像八字课堂一样解释术语。输出必须围绕四段：1五行能量速懂，2过去状态回顾，3现在的障碍，4未来工作与财富。第一段开头必须先点明生肖和纳音命格；生肖和纳音必须引用【程序排盘预校验】里的“生肖”和“年柱纳音”，不得根据生日字符串格式自行猜生肖；只点到为止，不展开生肖鸡汤，马上转入五行能量。五行必须全讲：按木、火、土、金、水顺序，每个元素用1句说明此人这里是强、弱、平衡或受克，并翻译成生活状态；五行讲完后再总结最强的1-2种能量和最需要补足/疏通的1种能量。禁止高频套话：你过去不是靠运气过日子的人、靠自己硬撑、适合做有结果有标准有反馈的事情、不适合长期待在混乱反复没有边界的环境、你不是没能力、方向收窄再加速。不能把不同命盘都写成压力、责任、硬扛模板；只有官杀、土重、财官压身、火土过旺或诉求指向压力时才讲压力承担。过去要从五行讲正负两面；现在突出2-3个贴盘障碍；未来只讲工作和财富，并且必须分别讲2026和2027：2026写事业机会、财富风险、需要避开的行为；2027写事业延续/转向、收入结构变化、适合提前布局的方向。2026-2027钩子必须具体有吸引力，写成：如果补具体出生时间，可以拆到月份，看哪几个月适合谈合作、换岗位、推副业，哪几个月要守现金、少签承诺、避开合作破财或选错方向。最后一段加入符合当前五行偏性的居家风水建议，具体说哪里少放什么、哪里可以放什么；木弱补东方绿植或木质感，火弱补南方暖光或红色小点缀，土弱补中心区陶瓷或方形收纳，金弱补西方/西北方金属色白色圆形或整洁收纳，水弱补北方蓝黑色玻璃感或流动感；某元素过旺就少在对应方位继续堆同类颜色材质。风水建议只能作为生活调整，不要承诺转运发财。不要推荐手串，除非用户明确问手串。"
        else:
