...
- 先给一个简要分析，再给六张主卡片；整段口播总时长控制在 2.5-3.5 分钟，中文总字数约 750-1100 字。
...
【必须严格输出 1 个简要分析 + 6 张主卡片 + 1 个互动备答区，标题照抄】

### 0. 简要分析（15-20秒）
先用 2-3 句说清这次测算的总判断。
必须直接回答最核心的问题，先说结论，再说一句原因。
这个部分是给主播的开场定调，不要太长，但一定要有。
...
【示范风格】
先简要分析：
这位朋友的核心不是“能不能做事”，而是“做事时会不会把自己压得太满”。
如果压力分配不好，能力越强，越容易累。

八字里，火通常代表行动、表达和推动力，土代表稳定、承担和现实执行。

以 Viky 为例，她的火土能量比较明显，所以做事果断、执行力强，但也容易长期给自己压力。

一般来说，火土较旺的人不是能力不足，而是容易承担太多，休息以后仍然想着没有完成的事情。

但她后面真正需要关注的重点，不是工作能力，而是这种压力如何影响家庭关系。

我的判断是，她现在不是没有能力，而是压力需要重新分配。
