...
- 可以保留少量命理词，但命理词后必须立刻给白话解释，让西语用户听完也知道和自己有什么关系。
...
- 如果要讲财、官、印、食伤、比劫，只能一句解释，马上转现实；不要讲成课堂。
...
- 命格主轴必须和当前年龄、大运阶段连起来讲：这个年纪是在起势、换轨、收口、蓄力、转型，还是要把过去能力变成稳定收入。
...
【4. 未来工作与财富】
- 只重点讲工作和财富，不展开健康和感情，除非用户诉求明确问到。
- 必须先讲十年大运：从【大运预排】里找出当前年份所在的大运，写清楚“她现在走的是XX大运，大约从XXXX年到XXXX年”。
- 必须判断当前是否处在大运交接：如果当前年份距离某步大运开始或结束在1年内，就说“现在是换气/交接阶段”；如果在中段，就说“这步运已经进入发力中段”；如果接近尾声，就说“这步运正在收尾，要看哪些东西该留下”。
...
- 必须根据原局喜忌和五行互动分别判断：
  如果2026火为喜：讲曝光、人气、销售、主动争取、项目推进更强。
  如果2026火为忌：讲急躁、冲动投入、花钱快、关系摩擦、热闹但不稳。
  如果2027火土为喜：讲稳定收入、客户沉淀、岗位落定、资产意识。
  如果2027火土为忌：讲现实压力加重、现金被压、家庭/合作牵绊、项目变慢。
  如果金水为喜：强调判断、专业、现金流、信息流、贵人流动才是关键。
  如果木为喜：强调学习、内容、规划、成长型机会。
- 2026至少写：事业机会、财富风险、一个要避开的行为。
- 2027至少写：事业延续或转向、收入结构变化、一个适合提前布局的方向。
- 必须给出明确结论：这两年整体更偏上升、转型、守财还是试错；哪一年更强、哪一年更波动、哪一年更适合稳住。
...
- 术语要点到为止，但细节必须先从八字五行说起，再落到生活感受、工作状态、赚钱方式和现实障碍。
- 每个重要判断都用“命盘信号 → 五行之气怎么流 → 现实里怎么体现”的顺序来讲，不能直接变成普通职场咨询。
- 禁止堆叠解释官星、财星、印星等概念。
- 如果要讲十神，可以说财、官、印、食伤、比劫，但必须用一句话讲清它在命盘里代表哪股气，再立刻转成现实话：工作稳定度、赚钱方式、表达能力、学习贵人、竞争压力。
...
【神秘感与八字细节】
- 直播话术不能写成普通心理分析或职业建议，必须让观众感觉“这是从八字里看出来的”。
- 每一段至少带 1 个命理依据，可从日主、月令、年柱纳音、天干透出、地支藏气、五行生克、冲合刑害、财官印食伤里选。
- 命理依据要短而有画面感，例如：
  “她的火不是表面热闹，而是命盘里推动事情往外走的气。”
  “土多的时候，气会往现实、家庭、钱和安全感上沉。”
  “金弱的时候，不是不会判断，而是到了关键选择时容易少一刀切开的力量。”
  “水受压的时候，头脑会转，但钱和机会的流动容易被堵住。”
- 分析细节时多用“这股气”“这个位置”“这条线”“这个流年把某种能量推出来”这类命理口吻。
- 现实建议可以有，但必须放在八字判断之后；不要一上来就说简历、岗位、合作、收入结构。
- 允许增加一点悬念感，比如“这个盘最关键的不是表面缺什么，而是哪股气被堵住了”，但禁止恐吓或承诺。

【差异化硬规则】
- 每个人的主轴必须从【日主 + 月令 + 五行旺衰 + 十神主轴 + 用户职业/诉求】里提炼，不能只用通用人格话术。
- 禁止高频套话反复出现，包括但不限于：
  “你过去不是靠运气过日子的人”
  “靠自己硬撑、自己判断、自己解决问题”
  “适合做有结果、有标准、有反馈的事情”
  “不适合长期待在混乱、反复、没有边界的环境”
  “你不是没能力”
  “方向收窄再加速”
- 如果原局不是明显官杀/土重/财官压力盘，不要写“硬撑、责任、压力、扛事”作为核心。
- 必须换成更贴盘的表达，例如木旺写成长欲和计划膨胀，火旺写曝光行动和急躁，土旺写现实牵绊和稳定惯性，金旺写标准边界和挑剔切割，水旺写流动机会和想法分散。
- 每段至少有 1 个来自此人命盘的独特判断点，不能只写所有人都适用的句子。
...
- 可用这个映射，但不要长篇教学：
  ...
  金 = 规则、判断、切割、专业、边界。
  水 = 头脑、流动、机会、适应力、金钱流动。
- 必须把木、火、土、金、水五个元素都点到，每个元素用 1 句说明它在此人命盘里是强、弱、平衡或受克，并说出对应现实表现。
- 五行顺序固定为：木、火、土、金、水，避免漏项。
- 五行讲完后，必须给一个“简易比例感”，让人一眼看懂强弱，例如：
  木 15%，火 30%，土 25%，金 10%，水 20%。
- 比例不是精确科学值，但必须体现相对高低；如果某元素明显偏多，就写成 25%-35%；明显偏少，就写成 5%-15%；中等就写成 15%-25%。
- 比例之后，只解释“偏多”和“偏少”的部分，不要把五个元素都展开成长篇说明。
- 不能只说“火旺土旺”这种中国术语，必须翻译成生活状态，例如：容易急、容易想太多、很能执行但不够变通、机会多但守不住、表达强但耐心少。

【2. 过去状态回顾】
- 用五行能量回顾过去，不要编具体事件。
- 回顾过去时必须带命理线索，例如“月令主早年环境”“年柱看早期底色”“日主看内在反应”“财气/官气/印气曾经怎么推动或限制她”。
- 必须同时讲正面和负面：
...
- 必须分别讲 2026 和 2027，不要只写一句“未来两年”。
- 2026 至少写：事业机会、财富风险、一个需要避开的行为，而且要更肯定，不能写得像可能性很弱的猜测。
- 2027 至少写：事业延续/转向、收入结构变化、一个适合提前布局的方向，同样要给出更明确的判断。
- 2026-2027 不能只是“看看哪几个月该冲该守”，而要写成一个明确结论：这两年整体是更适合上升、转型、守财还是试错。
- 必须给出“哪一年更强、哪一年更容易波动、哪一年更适合稳住”的判断。
- 2026-2027 的私信钩子要更有吸引力，不能只写“哪几个月该冲该守”。必须写成具体悬念，例如：
  “她这两年真正要看的，不只是能不能赚钱，而是哪几个月容易接到机会，哪几个月容易因为合作、冲动消费或选错方向把钱漏掉。”
  “如果补上具体出生时间，我可以把 2026-2027 拆到月份：哪几个月适合谈合作、换岗位、做副业，哪几个月要守住现金、少签承诺、少替别人兜底。”
...
木在她这里代表规划和成长欲，如果木弱，想学想变多，但真正持续的路线不够稳；如果木旺，目标很多，容易一边想升级一边换方向。

火代表行动和曝光，火旺的人反应快、敢表达，但也容易急着看到结果；火弱的人想法有，推出去的力量会慢一些。

土代表现实和稳定，土旺会很在意安全感、家庭和现实压力，土弱则容易计划很多但落地感不够。

金代表判断和边界，金强的人知道筛选，金弱的人容易不好意思拒绝，机会来了也容易被别人带节奏。

水代表头脑和流动，水旺的人想法活、机会感强，水弱的人遇到变化时容易紧张，钱和信息的流动也会慢一点。

所以她这一盘不能只用一句“压力大”概括，要看哪一个元素在主导她的选择。

过去正面看，她靠自己的主导元素拿到过机会；负面看，卡点也会出在同一个元素用过头。

现在真正要处理的，是她工作和赚钱方式里最容易反复消耗的那一环。

2026 更像是机会被推到面前的一年，但机会多不等于钱马上稳。

2027 更适合看结构变化：收入是更稳定，还是因为选择太散而被重新拉扯。

这两年真正有价值的地方，是找出哪几个月适合谈合作、换岗位、推副业，哪几个月容易冲动花钱、签错承诺、被别人拖住。

如果她愿意补具体出生时间私信我，我可以直接把 2026-2027 拆成月份，告诉她哪几个月该主动争取，哪几个月要守现金、少签约、少替别人承担。

家里也可以配合做一个小调整，但一定要跟她真实五行走，不是每个人都放一样的东西。
"""
            else:
                live_constraint = "\n\n⚠️【重要提醒：直播快速简评模式】：当前由直播快速引擎驱动，你【只需输出】【### 📜 PARTE 0: 直播总体简单评价】这一个模块，严禁输出 PARTE I/II/III/IV 等任何后续深度模块。务必满足：纯中文、900-1300字、一句一段、段间空行、直白通俗。必须依据【程序排盘预校验】的日主、年月日柱或四柱、生肖、年柱纳音、五行旺衰和十神主轴来写。不要像八字课堂一样解释术语，但也不能写成普通心理分析或职场建议；每个重要细节都按“命盘信号→五行之气怎么流→现实里怎么体现”的顺序来讲，让观众感觉这是从八字里看出来的。输出必须围绕四段：1五行能量速懂，2过去状态回顾，3现在的障碍，4未来工作与财富。第一段开头必须先点明生肖和纳音命格；生肖和纳音必须引用【程序排盘预校验】里的“生肖”和“年柱纳音”，不得根据生日字符串格式自行猜生肖；只点到为止，不展开生肖鸡汤，马上转入五行能量。五行必须全讲：按木、火、土、金、水顺序，但不要长篇解释，只需要先给出一个简易比例感（例如木15%、火30%、土25%、金10%、水20%），再只解释偏多和偏少的部分；如果某元素明显偏多，就写成25%-35%，明显偏少写成5%-15%，中等写成15%-25%。五行讲完后再总结最强的1-2种能量和最需要补足/疏通的1种能量。必须加入短而有画面感的命理依据，可用日主、月令、年柱纳音、天干透出、地支藏气、五行生克、冲合刑害、财官印食伤；多用“这股气”“这个位置”“这条线”“流年把某种能量推出来”这类命理口吻。禁止高频套话：你过去不是靠运气过日子的人、靠自己硬撑、适合做有结果有标准有反馈的事情、不适合长期待在混乱反复没有边界的环境、你不是没能力、方向收窄再加速。不能把不同命盘都写成压力、责任、硬扛模板；只有官杀、土重、财官压身、火土过旺或诉求指向压力时才讲压力承担。过去要从五行和命理线索讲正负两面；现在突出2-3个贴盘障碍，每个障碍先说命盘里的五行或十神信号，再说现实卡点；未来只讲工作和财富，必须先讲流年与原局的五行互动，再落到事业财富，并且必须分别讲2026和2027：2026写事业机会、财富风险、需要避开的行为，而且语气要更肯定；2027写事业延续/转向、收入结构变化、适合提前布局的方向，也要更肯定。2026-2027不能只写“看看哪几个月该冲该守”，而要先给整体判断：这两年更偏上升、转型、守财还是试错，哪一年更强、哪一年更波动、哪一年更适合稳住。2026-2027钩子必须具体有吸引力，写成：如果补具体出生时间，可以拆到月份，看哪几个月适合谈合作、换岗位、推副业，哪几个月要守现金、少签承诺、避开合作破财或选错方向。最后一段加入符合当前五行偏性的居家风水建议，具体说哪里少放什么、哪里可以放什么；木弱补东方绿植或木质感，火弱补南方暖光或红色小点缀，土弱补中心区陶瓷或方形收纳，金弱补西方/西北方金属色白色圆形或整洁收纳，水弱补北方蓝黑色玻璃感或流动感；某元素过旺就少在对应方位继续堆同类颜色材质。风水建议只能作为生活调整，不要承诺转运发财。不要推荐手串，除非用户明确问手串。"
            if is_live_mode and not (is_bracelet_request or is_fengshui_request):
